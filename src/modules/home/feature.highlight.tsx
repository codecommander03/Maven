...
const FeatureHighlight = () => {
    return (
        <div className="w-full md:flex items-center bg-[#F0ECFF] py-5 text-center md:py-12 md:text-left md:min-h-[55vh]">
            <div className="w-full md:w-[50%] flex justify-center">
                <Image
                    src="https://media.beehiiv.com/cdn-cgi/image/fit=scale-down,onerror=redirect,format=auto,width=640,quality=75/www/homepage/Create.png"
                    alt=""
                    width={400}
                    height={400}
                    className="w-[85%] ml-5"
